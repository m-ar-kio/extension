...
export function appendTagModal(bm) {
  ...
  tagModal.innerHTML = `
    <div style="display: flex;flex-flow: column nowrap;align-items: center;align-content: center;justify-content: flex-start;">
      <p style="font-weight:bold;margin:8px;color:#222326;">Add Tags</p>
      <textarea id="mark-tags" style="width:250px;height:60px;border:1.5px solid #222326;display:block;outline-color:#222326;padding:6px;font-size: 18px;line-height: 24px;"></textarea>
      ...
      <div style="display:flex;flex-flow:row nowrap;align-items:center;justify-content:space-between;width:100%;">
        <button id="mark-cancel" style="box-shadow:6px 6px #b7b9bf;margin-top:10px;background:white;border:1.5px solid #b7b9bf;padding:6px 20px;cursor:pointer;margin:0 10px;color:#222326;">CANCEL</button>
        <button id="mark-confirm" style="box-shadow:6px 6px #222326;margin-top:10px;background:white;border:1.5px solid #222326;padding:6px 20px;cursor:pointer;margin:0 10px;color:#222326;">CONFIRM</button>
      </div>
    </div>
  `
  tagModal.style = `
